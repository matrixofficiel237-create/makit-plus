...
export const api = {
  ...
  payments: {
    initiate: (body: { telephone: string; amount: number; method: "momo" | "orange"; orderId?: string; userName?: string; userEmail?: string }) =>
      apiFetch<{ success: boolean; reference: string; operator: string | null; ussdCode: string | null; externalReference: string; message: string }>("/payments/initiate", { method: "POST", body: JSON.stringify(body) }),
  },
  referral: {
    get: (userId: string) =>
