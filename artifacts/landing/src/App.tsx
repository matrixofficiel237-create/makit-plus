  ...
  return (
    <footer className="bg-gray-900 pt-24 pb-12 px-6 text-white/70">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
        ...
        <div>
          <h4 className="text-white font-bold text-xl mb-8 tracking-tight">Contact & Réseaux</h4>
          <ul style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <li style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <a href="tel:+237658237831" style={{ color: "rgba(255,255,255,0.9)", textDecoration: "none", fontSize: 14, fontWeight: 500 }}>
                <span style={{ color: "rgba(255,255,255,0.45)", fontSize: 11, display: "block", marginBottom: 1 }}>Téléphone</span>
                +237 658 237 831
              </a>
            </li>
            ...
            <li style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <a href="https://wa.me/237658237831" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,0.9)", textDecoration: "none", fontSize: 14, fontWeight: 500 }}>
                <span style={{ color: "rgba(255,255,255,0.45)", fontSize: 11, display: "block", marginBottom: 1 }}>WhatsApp</span>
                658 237 831
              </a>
            </li>
            ...
            <li style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <a href="mailto:makit4079@gmail.com" style={{ color: "rgba(255,255,255,0.9)", textDecoration: "none", fontSize: 14, fontWeight: 500 }}>
                <span style={{ color: "rgba(255,255,255,0.45)", fontSize: 11, display: "block", marginBottom: 1 }}>Email</span>
                makit4079@gmail.com
              </a>
            </li>
            ...
            <li style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <a href="https://facebook.com/Makitplus" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,0.9)", textDecoration: "none", fontSize: 14, fontWeight: 500 }}>
                <span style={{ color: "rgba(255,255,255,0.45)", fontSize: 11, display: "block", marginBottom: 1 }}>Facebook</span>
                Makit+
              </a>
            </li>
            ...
            {/* Instagram */}
            <li style={{ display: "flex", alignItems: "center", gap: 14 }}>
              <div style={{ width: 40, height: 40, borderRadius: "50%", background: "radial-gradient(circle at 30% 107%, #fdf497 0%, #fd5949 45%, #d6249f 60%, #285AEB 90%)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              ...
              <a href="https://instagram.com/Makitplus" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,0.9)", textDecoration: "none", fontSize: 14, fontWeight: 500 }}>
                <span style={{ color: "rgba(255,255,255,0.45)", fontSize: 11, display: "block", marginBottom: 1 }}>Instagram</span>
                Makit+
              </a>
            </li>
            ...
            {/* TikTok */}
            <li style={{ display: "flex", alignItems: "center", gap: 14 }}>
              <div style={{ width: 40, height: 40, borderRadius: "50%", background: "#010101", border: "1px solid rgba(255,255,255,0.15)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              ...
              <a href="https://tiktok.com/@Makitplus" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,0.9)", textDecoration: "none", fontSize: 14, fontWeight: 500 }}>
                <span style={{ color: "rgba(255,255,255,0.45)", fontSize: 11, display: "block", marginBottom: 1 }}>TikTok</span>
                Makit+
              </a>
            </li>
